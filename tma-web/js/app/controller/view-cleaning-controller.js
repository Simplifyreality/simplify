angular.module('tmweb').controller('ViewCleaningController', ['$rootScope', '$scope', '$route', '$location', '$translate', '$routeParams', '$window', 'FaultService', 'FiltersTransmissionService', function($rootScope, $scope, $route, $location, $translate, $routeParams, $window, faultService, FiltersTransmissionService) {
  ...
  $scope.viewAll = FiltersTransmissionService.getFilter('cleaningControllers');
